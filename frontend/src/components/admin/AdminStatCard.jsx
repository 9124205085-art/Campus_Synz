  ...
  inactive: (
    <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        ...
        d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"
      />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 8l-4 4M14 8l4 4" />
    </svg>
  ),
  admin: (
    <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function AdminStatCard({
  ...
  return (
    <Tag
      ...
      onClick={onClick}
      className={`w-full rounded-2xl bg-white p-5 text-left shadow-md ${
        onClick ? 'cursor-pointer transition hover:shadow-lg hover:ring-2 hover:ring-slate-200' : ''
      }`}
    >
